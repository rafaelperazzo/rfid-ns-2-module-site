...
href="http://www.gs1.org/gsmp/kc/epcglobal/uhfc1g2/uhfc1g2_1_2_0-standard-20080511.pdf">
    ...
    <p style="color: rgb(0, 0, 0); font-size: medium; font-style: normal;
      ...
      can be shown bellow<sup>*</sup></p>
    <sub><cite>* The paper values are not exact. Until now the authors did not
        provide the table that generated the curve. The points were estimated by
        linear interpolation assuming that the points bellow are correct. </cite></sub><sub><cite><br>
      </cite></sub><sub><cite>(50,160) and (500,1500)</cite></sub><br>
    <br>
    <table style="width: 100%;" border="0">
      <tbody>
        <tr>
          <td><img style="width: 690px; height: 483px;" alt="image1"
              src="identification.jpg"><br>
          </td>
          <td><img style="width: 636px; height: 444px;" alt="image2"
              src="dif.jpg"><br>
          </td>
        </tr>
      </tbody>
...
href="http://sourceforge.net/projects/nsnam/files/allinone/ns-allinone-2.35/ns-allinone-2.35.tar.gz/download">ns-allinone-2.35
    ...
    <table style="width: 100%" border="1">
      <tbody>
        ...
        <tr>
          <td style="vertical-align: top;">Simulation scripts<sup>*</sup> used
            to generate values used on graphics above<br>
            <br>
            <sub>*You should have the perl pack</sub><sub>ages:</sub><sub><br>
            </sub><sub><a
href="http://search.cpan.org/%7Eyunfang/Statistics-TTest-1.1.0/PointEstimation.pm">Statistics::

                PointEstimation</a></sub><sub><br>
            </sub><sub><a
href="http://search.cpan.org/%7Ecolink/Statistics-Descriptive-2.6/Descriptive.pm"><span
                  style="text-decoration: underline;">Statistics::Descriptive</span></a></sub></td>
