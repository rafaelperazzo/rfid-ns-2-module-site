...
<html>
  ...
  <body>
          ...
          <td>
            ...
            <p style="text-align: center;"><span style="font-style: italic;">Last
                ...
                update: <php title="echo date (&quot;d/m/Y - H:..."
                  xmlns="http://disruptive-innovations.com/zoo/bluegriffon"><!--?php echo date ("d/m/Y - H:i:", filemtime("rfid_module-doc.php"));?--></php><php
                  title="echo date (&quot;d/m/Y - H:..."
                  xmlns="http://disruptive-innovations.com/zoo/bluegriffon"><!--?php echo date ("d/m/Y - H:i", filemtime("rfid_module-doc.php"));?--></php><br>
              </span></p>
          </td>
        </tr>
      </tbody>
    </table>
    <a href="rfid_module.html"><br>
      HOME</a><br>
    ...
    <span style="font-family: Courier New,Courier,monospace;">for {set i 0} {$i
    ...
    </span><span style="font-family: Courier New,Courier,monospace;">#LOCALIZAÇÃO
      ...
      ALEATÓRIA DAS TAGS</span><span style="font-family: Courier
      New,Courier,monospace;"><br>
    ...
    <hr style="color: rgb(0, 0, 0); font-family: 'Times New Roman'; font-size:
      ...
      inline !important; float: none;"><a href="rfid_module.html">HOME</a><br>
      <br>
    </span>
      ...
      <tbody>
        <tr>
          ...
          <td><span style="color: rgb(0, 0, 0); font-family: 'Times New Roman';
              ...
              advisor Prof. <a href="http://www.ime.usp.br/%7Ebatista">Daniel
                Macêdo Batista</a>, <a href="http://www.usp.br">USP</a>, <a
